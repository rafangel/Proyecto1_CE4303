...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/home/rafa/os-pintos/MLQ_pintos/src/threads/build/loader.bin") if !defined $name;
    #$name = find_file ("/home/rafa/os-pintos/MLQ_pintos/src/userprog/build/loader.bin") if !defined $name;
